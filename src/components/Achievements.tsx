...
export default function Achievements() {
  return (
    <section id="achievements" className="py-20 bg-[#161b22]/50">
      <div className="max-w-6xl mx-auto px-6">
        {/* Section Header */}
        <div className="text-center mb-16">
          <p className="text-[#58a6ff] font-mono text-sm mb-2">04. Achievements</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {achievements.map((achievement, index) => (
            <div
              key={index}
              className="bg-[#21262d] border border-[#30363d] rounded-lg p-6 card-hover text-center group"
            >
              <div
                className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center text-3xl transition-transform group-hover:scale-110"
              ...
              <h3 className="text-[#f0f6fc] font-semibold mb-2">
                {achievement.title}
              </h3>
        ...
        <div className="mt-16 text-center">
          <h3 className="text-xl font-semibold text-[#f0f6fc] mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["Cred Pay", "Apple Pay", "Google Pay", "RBI PPI Compliance", "SOC2 Compliance"].map(
              (integration, index) => (
                <span
                  key={index}
                  className="px-6 py-3 bg-[#21262d] border border-[#30363d] rounded-full text-[#8b949e] hover:text-[#f0f6fc] hover:border-[#58a6ff] transition-all cursor-default"
                >
                  {integration}
                </span>
              )
