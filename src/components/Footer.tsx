export default function Footer() {
  return (
    <footer className="py-10 border-t border-[#30363d]">
      <div className="w-full max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-[#8b949e] text-sm md:text-base">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="text-[#8b949e] hover:text-[#58a6ff] text-sm md:text-base transition-colors flex items-center gap-2"
            >
